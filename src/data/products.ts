export interface Product {
  ...
  features: string[]
  specifications: {
    // Common optional fields to cover ALL product variations
    ...
    dimensions?: string
    warranty?: string
    // Extra fields seen in your dataset
    power?: string
    range?: string
    waterRating?: string
    dpi?: string
    ...
    cableLength?: string
    sensitivity?: string
    [key: string]: string | undefined // fallback for any new spec
  }
  colors: string[]
  tags: string[]
  shipping: {
