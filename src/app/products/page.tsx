...
if (sortBy === 'price-low') {
  ...
  const averageRating = (filteredProducts.reduce((acc, p) => acc + (p.rating || 0), 0) / filteredProducts.length).toFixed(1)
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full md:w-[50%] border border-gray-300 rounded-lg px-4 py-2 shadow-sm 
